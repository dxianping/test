...
function e(n,k,j){
	...
	function m(){
		var q=this,o=0,p=0,n=0;q.init=function(t){
			q.slider=t;
		...
		function s(){
			...
			i(q.slider,{overflow:"hidden"});
			i([q.playPause,
				q.autoPlayState?q.btnPause:q.btnPlay,
				q.arrowPrev,q.arrowNext,
				q.arrowPrev.getElementsByTagName("label")[0],
				q.arrowNext.getElementsByTagName("label")[0]],
				{
					display:"block",opacity:1,
				});
			...
			for(var t in q.description){
				var w=c(q.description[t],
					"cs_title")[0],v=c(q.description[t],
					"cs_descr")[0];
					if(w){u.push(w);
			...
			function k(){
				...
				g(q.playPause,"click",function(){
					...
					(q.btnPlay,q.btnPause,q.autoPlayState)
				})
			}
			function r(v){
				if(o||v==n){
